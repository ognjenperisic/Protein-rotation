...
int main()
{
   ...
   char* dir1="E:\\colaboration\\QYS\\sheq_smwb_120606";
   char* dir2="E:\\colaboration\\QYS\\sheq_smwb_120606";
   ...
   if (_chdir(dir1)==0)
   {         
        hSearch = FindFirstFile("eqtop7.pdb", &FileData);
        ...
        {	
            ...
            {  
                if (!fFinished)	      
                {
                    ...
                    _chdir(dir2);
                    carbon->Save(FileData.cFileName,dir1,"rot2.pdb");				
                    _chdir(dir1);
